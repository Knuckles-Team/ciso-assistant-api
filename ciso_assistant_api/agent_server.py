...
def agent_server():
    ...
    DEFAULT_AGENT_NAME = setting(
        "DEFAULT_AGENT_NAME", meta.get("name", "CISO Assistant")
    )
    DEFAULT_AGENT_DESCRIPTION = setting(
        "AGENT_DESCRIPTION",
        meta.get(
            "description",
            "AI agent for CISO Assistant privacy and compliance management.",
        ),
    )
    ...
    packaged_config = files("ciso_assistant_api").joinpath("bundled_mcp.json")
    config_context = (
