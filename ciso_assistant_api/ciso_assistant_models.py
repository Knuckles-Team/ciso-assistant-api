#!/usr/bin/python
"""Shared models for the CISO Assistant API client.

The CISO Assistant surface spans ~1,500 OpenAPI operations. Rather than generate
hundreds of brittle per-schema Pydantic models, the client passes
