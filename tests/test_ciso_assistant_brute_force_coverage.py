...
from ciso_assistant_api.api._operation_manifest import ACTIONS_BY_DOMAIN, OPERATIONS
...
def test_every_client_method_executes(mock_session):
    _ = mock_session
    api = Api(url="https://test.my.ciso_assistant.com", token="test")
...
def test_every_mcp_action_routes():
    ...
    from ciso_assistant_api import mcp as mcp_pkg
